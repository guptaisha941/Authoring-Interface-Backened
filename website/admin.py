...
conn = mysql.connect()
cursor = conn.cursor()
cursor.execute("CREATE TABLE IF NOT EXISTS admin (admin int AUTO_INCREMENT , admin_name varchar(255), email varchar(255), password varchar(16), PRIMARY KEY(admin_id))")
conn.commit()
cursor.close() 
conn.close() 
